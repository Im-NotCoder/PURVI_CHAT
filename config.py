...
OWNER_ID = int(getenv("OWNER_ID", "7001106191"))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "kuthuvilakuu")
UPDATE_CHNL = getenv("UPDATE_CHNL", "kuthuvilakuu")
OWNER_USERNAME = getenv("OWNER_USERNAME", "@Va_Run1")
